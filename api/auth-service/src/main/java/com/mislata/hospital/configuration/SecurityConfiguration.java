...
import com.mislata.hospital.filtro.JwtTokenFilter;
import com.mislata.hospital.model.JwtToken;
import com.mislata.hospital.service.UsuarioDetailsService;
...
//			.antMatchers("/api/medicamentos").hasAnyAuthority("ENFERMERIA")
//			.antMatchers("/api/recetas").hasAnyAuthority("MEDICINA")
